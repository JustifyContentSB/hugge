...
$(document).ready(function(){
    ...
    let gallerySwiper2 = new Swiper(".gallery-2 .gallery__swiper", {
        slidesPerView: 1,
        slidesPerGroup: 1,
        spaceBetween: 20,
        speed: 500,
    ...
    let gallerySwiper3 = new Swiper(".gallery-3 .gallery__swiper", {
        slidesPerView: 1,
        slidesPerGroup: 1,
        spaceBetween: 20,
        speed: 500,
    ...
    let gallerySwiper4 = new Swiper(".gallery-4 .gallery__swiper", {
        slidesPerView: 1,
        slidesPerGroup: 1,
        spaceBetween: 20,
        speed: 500,
